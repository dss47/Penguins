...
$routes = [
	...
	'POST /admin/data/categories/delete'            => static fn() => json_response($adminController->deleteCategory($body)),
	'POST /admin/data/providers/create'             => static fn() => json_response($adminController->createProvider($body)),
	'POST /admin/data/providers/update'             => static fn() => json_response($adminController->updateProvider($body)),
	'POST /admin/data/providers/delete'             => static fn() => json_response($adminController->deleteProvider($body)),
	'POST /admin/data/features/create'              => static fn() => json_response($adminController->createFeature($body)),
	'POST /admin/data/features/update'              => static fn() => json_response($adminController->updateFeature($body)),
	'POST /admin/data/features/delete'              => static fn() => json_response($adminController->deleteFeature($body)),
